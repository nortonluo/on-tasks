...
module.exports = DellWsmanCatalogJobFactory;
di.annotate(DellWsmanCatalogJobFactory, new di.Provide('Job.Dell.WsmanCatalog'));
di.annotate(DellWsmanCatalogJobFactory, new di.Inject(
    'Job.Dell.Wsman.Base',
    'Logger',
    'Promise',
    'Assert',
...
function DellWsmanConfigCatalogJobFactory(
    BaseJob,
    Logger,
    Promise,
    assert,
